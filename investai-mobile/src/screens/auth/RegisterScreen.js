      ...
      >
        ...
        <Animated.View style={[styles.heroContainerWrapper, animatedHeroStyle]}>
          ...
          >
            ...
            <Animated.View style={[styles.logoWrapper, animatedLogoStyle]}>
              ...
              <Text style={[styles.brandSlogan, { color: isDark ? 'rgba(224, 242, 254, 0.8)' : '#E0F2FE' }]}>Join the Future of Investing</Text>
            </Animated.View>
          </LinearGradient>
        </Animated.View>
        ...
        <Animated.View style={[styles.formContainer, animatedFormStyle, { backgroundColor: theme.formBg }]}>
          <View style={styles.formHeader}>
            ...
            <Text style={[styles.subText, { color: theme.textSecondary }]}>Start your journey with InvestAI today</Text>
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={[styles.inputWrapper, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder, borderWidth: isDark ? 0 : 1 }]}>
              <MaterialIcons name="lock-reset" size={20} color={theme.textSecondary} style={styles.inputIcon} />
              <TextInput
            ...
            <TouchableOpacity style={[styles.signInButton, { backgroundColor: theme.primary, marginTop: 24 }]} activeOpacity={0.8}>
            ...
            <TouchableOpacity style={[styles.googleButton, { backgroundColor: theme.googleBtnBg, borderColor: theme.googleBtnBorder }]} activeOpacity={0.7}>
              ...
              <Text style={[styles.googleButtonText, { color: theme.googleText }]}>Sign up with Google</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.footer}>
            <Text style={[styles.footerText, { color: theme.textSecondary }]}>
              ...
              <Text style={[styles.registerLink, { color: theme.primary }]} onPress={() => navigation.navigate('Login')}>
                Login
              </Text>
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  heroContainer: {
    height: height * 0.4, // Slightly shorter hero for more fields
